...
// create by big 
class inwshop_taxinvoiceid_model extends CI_Model
{
	...
	function __construct()
	{
 	...
 	function insert($data){
    	$this->db->insert('inwshop_taxinvoiceid', $data);
	...
	function update($data,$id){
    	$this->db->where('inwshop_taxinvoiceid_id',$id);
		$this->db->update('inwshop_taxinvoiceid',$data);
		//echo $this->db->last_query();
	}
	...
	function delete($id){
		$this->db->where('inwshop_taxinvoiceid_id',$id);
		$this->db->delete('inwshop_taxinvoiceid');
	}

	function select_all(){
			$this->db->select('*');
			$this->db->from('inwshop_taxinvoiceid');
			$query = $this->db->get();
