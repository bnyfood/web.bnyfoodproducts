<div class="page">
  <div class="page-header">
    <h1 class="page-title">แก้ไข Material Volume</h1>
              ...
              <div class="example-wrap">
                <div class="example">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody id="material-list">
                            <tr>
                              ...
                              <td>
                              <input type="radio" name="web_material_id" id="web_material_id" value="<?php echo $arr_material['material_id'];?>" checked>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <div class="col-md-12">
                      ...
                      <div id="vt_search">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody id="vt-list">
                            <tr>
                              <td><?php echo $arr_material_volume_type['web_material_volume_type'];?></td>
                              <td>
                              <input type="radio" name="web_material_volume_type_id" id="web_material_volume_type_id" value="<?php echo $arr_material_volume_type['web_material_volume_type_id'];?>" checked>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <div class="col-md-12">
                      ...
                      <div id="unit_search">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody id="unit-list">
                            <tr>
                              <td><?php echo $arr_material_unit['material_unit'];?></td>
                              <td>
                              <input type="radio" name="web_material_unit_id" id="web_material_unit_id" value="<?php echo $arr_material_unit['web_material_unit_id'];?>" checked>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="web_material_volume" id='web_material_volume' value="<?php echo $arr_volume_type['web_material_volume']?>"  autocomplete="off">
                    </div>
                  </div>
