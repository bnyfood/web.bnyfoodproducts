<div class="page">
  <div class="page-header">
    <h1 class="page-title">เพิ่ม Controller</h1>
  ...
  <div class="page-content">
    <div class="panel">
      <div class="panel-body container-fluid">
        <form role="form" name="user_add_form" id="user_add_form" action="<?php echo base_url()."config_system/page_permission_group/add_action";?>" method="post">
