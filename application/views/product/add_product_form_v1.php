    ...
    <div class="panel">
      <div class="panel-body container-fluid">
        <form class="upload-form" role="form" name="user_add_form" id="fileupload" action="<?php echo base_url()."upload/do_upload";?>" method="POST" enctype="multipart/form-data">  
          ...
          <hr>
          <form class="upload-form" role="form" name="user_add_form2" id="user_add_form2" action="<?php echo base_url()."product/product_add";?>" method="POST" enctype="multipart/form-data">  
          <div class="row row-lg">
            <div class="col-md-12 col-lg-6">
              <div class="example-wrap">
                ...
                <div class="example">
                  ...
                  <div class="form-group row">
                    <label class="col-md-2 col-form-label">จัดกลุ่มสินค้า : </label>
                    <div class="col-md-6">
                      <input type="checkbox" name="pro_set" id="pro_set">
                    </div>
                  </div>
          ...
          <div class="row row-lg" id="div_product_set"  style="display: none;">
            <div class="col-md-12 col-lg-6">
              <div class="example-wrap">
                <h4 class="example-title">ชุดสินค้า</h4>
                <div class="example">
                  <div class="form-group row">
                    <label class="col-md-2 col-form-label">สินค้า : </label>
                    <div class="col-md-6">
                      หหหหหหห
                    </div>
                  </div>
                        ...
                        <div class="panel-body">
                          <div class="example table-responsive">
                            <table class="table table-bordered">
                              <thead>
                                <tr>
                                  <th width="20%" id="variant1_val">Variant1</th>
                                  <th width="10%" id="variant2_val">Variant2</th>
                                  <th width="20%">ราคา</th>
