    ...
    <center>
      ...
      <table class="table1 table-borderless">
        ...
        <thead>
          ...
          <tr>
            <th colspan="8"><center><h1>รายงานภาษีขาย(TikTok)</h1>
            <div style="font-size:14px;font-weight:normal;">ภาษี = สินค้า − ส่วนลดร้านค้า (ไม่รวมค่าส่ง / ส่วนลดแพลตฟอร์ม)</div>
            </center></th>
          </tr>
          <tr>
      ...
      <table class="table2">
        ...
        <col data-col="tiktok" style="width:7%">
      ...
      <?php } ?>
        <tbody>
          <tr class="data-row <?php echo ($row_runner % 2) ? 'zebra-odd' : 'zebra-even'; ?>">
            ...
            ?>
            <td data-col="invoice" class="transacdetail" style="text-align:center"><a href="#" style="text-decoration: none" id="<?php echo base_url()."accounting/saletaxreport/tik_salereport_more/".$taxno?>" class="moretax" rel="nofollow"><?php echo $taxno_display;?></a></td>
...
<script>
  ...
  var ALL_COLS = ["no","date","invoice","buyer","taxid","price","seller","tiktok","totaldisc","ship","vatexcl","vat","vatincl"];
