  ...
  <body style="background: #FFF;">
    <div class="col-picker no-print">
      ...
      <div id="col_checks">
        ...
        <label><input type="checkbox" data-toggle-col="orderno" checked> ShoOrderNumber</label>
      ...
      <div style="color:#555;margin-top:4px;">มาตรฐาน (ส่งสรรพากร) = ลำดับ, วัน, ใบกำกับ, ShoOrderNumber, ผู้ซื้อ, เลขผู้เสียภาษี, มูลค่าสินค้า, ส่วนลดร้านค้า, ค่าขนส่ง, ราคาไม่รวม VAT, VAT, ราคารวม VAT — ไม่รวมส่วนลด Shopee / ส่วนลดรวม — แถบนี้ไม่ถูกพิมพ์</div>
    </div>
    <center>
      <?php
      if($validdata==0)
      ...
      <table class="table1 table-borderless">
        ...
        <thead>
          <tr>
              <th colspan="6" style="text-align: left;">เดือน/ปี ภาษี: <?php echo $month_label !== "" ? $month_label : ""; ?> เลขที่ใบกำกับภาษี: <?php echo "Shp".$order_start ."- Shp".$order_end; ?></th>
      ...
      <table class="table2">
        ...
        <thead>
          <tr class="colhead">
            ...
            <th data-col="orderno" style="text-align:center">ShoOrderNumber</th>
      ...
      <?php } ?>
        <tbody>
          ...
          <tr class="data-row <?php echo ($row_runner % 2) ? 'zebra-odd' : 'zebra-even'; ?>">
            ...
            <td data-col="orderno" class="transacdetail" style="text-align:center"><?php echo $row["order_sn"];?></td>
...
<script>
  ...
  var ALL_COLS = ["no","date","invoice","orderno","buyer","taxid","price","seller","shopee","totaldisc","ship","vatexcl","vat","vatincl"];
  var COL_WEIGHT = {
    no: 4, date: 9, invoice: 14, orderno: 13, buyer: 11, taxid: 10,
    price: 8, seller: 8, shopee: 7, totaldisc: 7, ship: 7,
