...
<table>
  ...
  <thead>
    ...
    <tr>
      <td colspan="4" class="taxinvoice"><center><span class="taxinvoice">ใบกำกับภาษีอย่างย่อ/ใบเสร็จรับเงิน</span></center></td>
    </tr>
    <tr>
      <td colspan="4" ><center><span class="taxinvoicenumber"><?php echo $row["taxinvoiceID"];?> <?php if(isset($row["is_tracking"]) && $row["is_tracking"] == 0){echo " (ไม่มี Tracking)";}?></span></center></td>
    </tr>
    <tr class="date-row">
    ...
    <tr class="colhead-row">
      ...
      if (!empty($row["suborder"])) {
        foreach ($row["suborder"] as $suborder_detail) {
          ...
          $unit_price = (float)$suborder_detail["item_price"];
          $line_qty = isset($suborder_detail["qty"]) ? (float)$suborder_detail["qty"] : 1;
          $line_amount = isset($suborder_detail["amount"]) ? (float)$suborder_detail["amount"] : ($unit_price * $line_qty);
          $key = ($sku !== '') ? ('sku:'.$sku.'|'.number_format($unit_price, 2, '.', '')) : ('name:'.$name.'|'.number_format($unit_price, 2, '.', ''));
          ...
          $agg_items[$key]['qty'] += $line_qty;
          $agg_items[$key]['amount'] += $line_amount;
        }
      }
    ...
    <tr class="qty-row">
      ...
      <td class="conclution amt-cell" ><div class="amt"><?php echo number_format($acc_qty, 0);?></div></td>
    </tr>
    <tr class="totals-row">
      <td  colspan=3 class="conclution" ><div style="text-align: right; ">รวมทั้งสิ้น:</div></td>
      <td class="conclution amt-cell" ><div class="amt"><?php echo number_format($row['price'],2);?></div></td>
    </tr>
    <tr class="totals-row">
      <td  colspan=3 class="conclution" ><div style="text-align: right; ">ส่วนลด:</div></td>
      <td class="conclution amt-cell" ><div class="amt"><?php echo number_format($row["seller_discount"],2);?></div></td>
    </tr>
    <tr class="totals-row">
    ...
    <tr class="totals-row">
      ...
      <td class="conclution amt-cell" ><div class="amt"><?php echo number_format($row["shipping_fee"],2);?></div></td>
    </tr>
    <tr class="totals-row">
    ...
    <tr class="totals-row">
      ...
      <td class="conclution amt-cell" ><div class="amt"><?php echo number_format($price_discount_seller_shipping,2);?></div></td>
    </tr>
      <tr>
        <td colspan="4" >
          <div style="text-align: center; font-size: 4em; line-height: 2em;"><span class="dateinfo">รวมทั้งสิ้น: <?php  echo number_format($price_discount_seller_shipping,2);?></span></div>
        </td>
      </tr>
      <tr>
      <td colspan="4" >
      ...
      <tr>
        <td colspan="4" >
          <div style="text-align: center; font-size: 3em; line-height: 1em;"><span class="dateinfo">TiktokOrderNo: <?php echo $row["order_number"];?></span></div>
        </td>
      </tr>
      <tr>
        <td colspan="4" ><div style="text-align: center; font-size: 3em; line-height: 1em;"><span class="dateinfo"></span></div>
        </td>
      </tr>
      </tbody>
    </table>
