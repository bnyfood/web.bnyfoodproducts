    ...
    <tbody>
      ...
      ?>   
        <tr> 
          ...
          <td  class="transacdetail" style="vertical-align: text-top;"><div style="text-align: right; padding-right:10px;"><?php echo number_format($suborder_detail["amount"],2);?></div></td>
        </tr><!--end tr-->
         <?php
         $numcount++;
