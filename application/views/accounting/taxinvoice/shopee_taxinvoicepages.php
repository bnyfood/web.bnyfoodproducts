...
<table>
  ...
  <thead>
      ...
      ?>
        <tr class="item-row <?php echo $zebra_class; ?>">
         ...
         $acc_qty += $agg_item["qty"];
          ...
          $price=$price_discount_seller;
          $pricebeforeVAT=$price/1.07;
          $VAT=$price-$pricebeforeVAT;
          $price_discount_seller_shipping = $price_discount_seller;
          $price_discount_seller_shipping_exclude_vat = $pricebeforeVAT;
          $price_discount_seller_shipping_vat = $VAT;
        ?>
        <tr>
    ...
    <tr class="totals-row">
      ...
      <td class="conclution amt-cell" ><div class="amt"><?php echo number_format(0,2);?></div></td>
    </tr>
    <tr class="totals-row">
