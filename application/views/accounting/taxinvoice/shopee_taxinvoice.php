  ...
  <div class="bny-doc-toolbar">
    ...
    <form class="bny-doc-search" role="form" name="taxinvoice_search_form" id="taxinvoice_search_form" action="<?php echo base_url()."accounting/taxinvoice/taxinvoice_search";?>" method="post">
      ...
      <select name="search_type" id="search_type" class="form-control" onchange="set_search(this);">
        ...
        <option value="1" <?php if($arr_search['search_type'] == "1"){echo "selected";}?>>Search form Date</option>
        <option value="2" <?php if($arr_search['search_type'] == "2"){echo "selected";}?>>Search Only Order Number</option>
        <option value="3" <?php if($arr_search['search_type'] == "3"){echo "selected";}?>>Search Start Order Number</option>
      </select>
