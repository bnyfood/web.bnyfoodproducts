                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      <select name="search_type" id="search_type" class="form-control" onchange="set_search(this);">
                        ...
                        <option value="1" <?php if($arr_search['search_type'] == "1"){echo "selected";}?>>Search form Date
                        <option value="2" <?php if($arr_search['search_type'] == "2"){echo "selected";}?>>Search Only Order Number
                        <option value="3" <?php if($arr_search['search_type'] == "3"){echo "selected";}?>>Search Start Order Number
                      </select>
                    </div>
                  </div>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $arr_order['order_sn']?></td>
                    <td><?php echo $arr_order['start_inv']?></td>
                    <td>
                      <?php 
                       if(!empty($arr_order["start_tiv"])){echo $arr_order["start_tiv"];}else{echo "-";}
                      ?>
                    </td>
                    <td><?php $datearr=explode(" ",$arr_order["transactiondate"]); echo $datearr[0];?></td>
                    ...
                    <td><?php echo $arr_order['order_status']?></td>
                    <td class="text-nowrap">
                      <?php //if($arr_order['order_status'] == "SHIPPED"){?>
                      <a href="<?php echo base_url();?>accounting/taxinvoice/textinvoice_addform/<?php echo $arr_order["order_sn"];?>/<?php echo $arr_search['platform'];?>" id="fancy_main" class="btn btn-outline btn-primary">ออกใบกำกับเต็มรูป</a>
                      <a href="javascript:void(0)" class="btn btn-outline btn-primary" onclick="window.open('<?php echo base_url();?>accounting/taxinvoice/shopee_taxinvoice_print/<?php echo $arr_order["order_sn"];?>', '_blank', 'location=yes,height=1000,width=1200,scrollbars=yes,status=yes');">พิมพ์ใบ</a>
                    <?php //}?>
                    </td>
                  </tr>
                <?php $row_runer+=1;}}?>
