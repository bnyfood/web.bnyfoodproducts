...
//echo $row_runner."--".$total_rows;
      ...
      <table class="table1 table-borderless">
        ...
        <thead>
          <tr>
            <th colspan="8"><center><h1>Purchase order</h1></center></th>
          </tr>  
          <tr>
      ...
      <table class="table2  table-striped">
        ...
        <thead>   
          ...
          <tr>    
            ...
            <th style="text-align:center">รายการวัถุดิบ</th>
            <th style="text-align:center;line-height: initial;">จำนวน</th>
            <th style="text-align:center;line-height: initial;">ราคา/หน่วย</th>
      ...
      <?php }   //new page?>
        <tbody>                                       
          ...
          <tr>
            ...
            <td class="transacdetail" style="text-align:center"><?php echo $row["supplier_name"];?> </td>
            <td class="transacdetail" style="text-align:center"><?php echo $row["material_name"];?> </td>
            <td class="transacdetail" style="text-align:center"><?php echo $row["qty"];?> </td>
            <td class="transacdetail"><?php echo number_format($row["unit_price"],2,".",",");?></td> 
