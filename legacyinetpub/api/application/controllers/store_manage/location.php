...
class Location extends CI_Controller
{
   ...
   function get_by_shop(){
    ...
    if($chk_auth['Status'] == "Success"){
     ...
     // echo $shopid_en."-->".$shopid."<--";
      ...
      $data = $this->store_location_model->select_by_shop_id_limit($shopid,$per_page);
  ...
  function location_add(){
    $arr_header = $this->api_auth_bl->get_header();
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $data_re = $this->store_location_model->insert($arr_data);
  ...
  function get_by_id(){
    ...
    if($chk_auth['Status'] == "Success"){
      ...
      $data = $this->store_location_model->select_by_id($id);
  ...
  function location_edit(){
    $arr_header = $this->api_auth_bl->get_header();
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $data_re = $this->store_location_model->update($arr_data,$id);
  ...
  function del_action(){
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $this->store_location_model->delete($id);
  ...
  function loaddata_more(){
    ...
    if($chk_auth['Status'] == "Success"){
     ...
     // echo $shopid_en."-->".$shopid."<--";
      ...
      $data = $this->store_location_model->select_by_shop_id_search($shopid,$location_search,$per_page,$offset,$sortby,$sorttype);
