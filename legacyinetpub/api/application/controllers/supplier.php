...
class Supplier extends CI_Controller
{
   ...
   function get_by_shop(){
    ...
    if($chk_auth['Status'] == "Success"){
     ...
     // echo $shopid_en."-->".$shopid."<--";
      ...
      $data = $this->web_supplier_model->select_by_shop_id_limit($shopid,$per_page);
  ...
  function get_by_shop_search(){
    ...
    if($chk_auth['Status'] == "Success"){
     ...
     // echo $shopid_en."-->".$shopid."<--";
      ...
      $data = $this->web_supplier_model->select_by_shop_id_search($shopid,$sipplier_search,$per_page,$offset,$sortby,$sorttype);
  ...
  function supplier_add(){
    $arr_header = $this->api_auth_bl->get_header();
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $supplier_province = $this->input->post('supplier_province');
        $supplier_district = $this->input->post('supplier_district');
        $supplier_subdistrict = $this->input->post('supplier_subdistrict');
        ...
        $data_re = $this->web_supplier_model->insert($arr_data);
  ...
  function get_by_id(){
    ...
    if($chk_auth['Status'] == "Success"){
      ...
      $data = $this->web_supplier_model->select_by_id($id);
  ...
  function supplier_edit(){
    $arr_header = $this->api_auth_bl->get_header();
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $data_re = $this->web_supplier_model->update($arr_data,$id);
  ...
  function del_action(){
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $this->web_supplier_model->delete($id);
