...
**/
class Material_volume_type extends CI_Controller
{
   ...
   function get_by_shop(){
    ...
    if($chk_auth['Status'] == "Success"){
     ...
     // echo $shopid_en."-->".$shopid."<--";
      ...
      $data = $this->web_material_volume_type_model->select_by_shop_id($shopid);
  ...
  function material_volume_search(){
    ...
    if($chk_auth['Status'] == "Success"){
     ...
     // echo $shopid_en."-->".$shopid."<--";
      ...
      $data = $this->web_material_volume_type_model->select_by_shop_search($shopid,$material_volume_search);
  ...
  function get_by_id(){
    ...
    $arr_header = $this->api_auth_bl->get_header();
      ...
      if($chk_auth['Status'] == "Success"){
        ...
        $web_material_volume_type_id = $this->uri->segment(4);  
        //$material_volume_id = $this->encryption_util->decrypt_ssl($material_volume_id_en);  

        $data_re = $this->web_material_volume_type_model->select_by_id($web_material_volume_type_id);
