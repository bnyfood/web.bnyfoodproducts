                        ...
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    <h4 class="mt-0 mb-3 mt-5">บริษัท บีเอ็นวายฟู้ด โพรดักส์ จำกัด</h4>
                                    <p class="text-muted mb-0">กรุณาลงชื่อเข้าใช้</p>  
                                </div> <!--end auth-logo-text-->  

                                
                                <form class="form-horizontal auth-form my-4" method="get" action="<?php echo base_url();?>admin/logined">
                                    ...
                                    <div class="form-group row mt-4" style="text-align:right">
                                        
                                        <p id="image_captcha"></p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="captcha-refresh" ><img src="<?php echo base_url().'assets/images/refresh.png'; ?>" width="50" /></a>
                                        <input type="text" class="form-control" id="captchaword" name="captchaword" placeholder="Your Answer">
