...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Laz DataSyncronization</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Lazada Data Syncronization</h4>
                        ...
                        <div class="col-lg-9">
                            <div class="card">                                
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div id="resault" class="col-sm-12">
...
$.ajax({ 
 ...
 $("#resault").HTML(response);
            ...
            if(response!="done")
            {
                  if(call_couinter<=2)
                  {
                    alert("will download: "+call_couinter);
                   getorders response; 
                   }
            }
        else
...
$( document ).ready(function() {
    ...
    //localStorage.removeItem("laztokenlife");

//var tid = setTimeout(refreshtoken, 2000);
//localStorage.setItem("laztokenlife",60); //
