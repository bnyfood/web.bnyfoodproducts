...
$('#sync_lazada').click(function(){
  ...
  return window.open('https://auth.lazada.com/oauth/authorize?response_type=code&redirect_uri=https://www.bnyfoodproducts.com/lazcallback&force_auth=true&client_id=123793&country=th&uuid=<?php echo uniqid();?>', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
