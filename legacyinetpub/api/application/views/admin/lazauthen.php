            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">LazAuthentication</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card">                                
                                                    <a href="https://auth.lazada.com/oauth/authorize?response_type=code&redirect_uri=https://www.bnyfoodproducts.com/lazcallback&force_auth=true&client_id=123793" target="_blank">Launch Laz Authentication</a>

                                                    <?php
                                                    if(isset($code))
                                                    {
                                                        echo "<br>Authentication Done:";
                                                        echo "<br>token:".$token;
                                                        echo "<br>refreshtoken:".$refreshtoken;
                                                        echo "<br>refresh_expires_in:".$refresh_expires_in;
                                                    }
                                                    ?>                                                                                    
                            </div><!--end card-->
                        </div><!--end col-->
