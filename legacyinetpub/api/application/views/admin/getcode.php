        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                   ...
                   <button type="button" class="btn btn-primary" id="getcode">getcode</button>
...
$('#getcode').click(function(){
  ...
  var timerref=null;
  setTimeout(function(){ 
  return window.open('https://auth.lazada.com/oauth/authorize?response_type=code&redirect_uri=https://www.bnyfoodproducts.com/lazcallback&force_auth=true&client_id=123793','_blank');
