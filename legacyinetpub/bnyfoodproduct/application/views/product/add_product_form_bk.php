              ...
              <div class="example">
                 ...
                 <div class="row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="number" class="form-control" name="Condition" id='Condition'  autocomplete="off">
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      <div class="panel">
                        <div class="panel-heading">
                          <h3 class="panel-title">Model Group</h3>
                          <input type="hidden" name="shop_id_en" id="shop_id_en" value="<?php echo $shop_id_en;?>" >
                          <button type="button" id="add_model" class="btn btn-primary" data-toggle="modal"
                    data-target="#Modal_add_model"><i class="icon wb-plus" aria-hidden="true"></i> เพิ่ม Model Group</button>
                        </div>
                    ...
                    <div class="col-md-12">
                      <div class="panel">
                        <div class="panel-heading">
                          ...
                          <input type="hidden" name="shop_id_en" name="ren_id" id="ren_id" value="<?php echo $ren_id;?>" >
                          <button type="button" id="add_model_data" class="btn btn-primary" data-toggle="modal"
                    data-target="#Modal_add_model_data"><i class="icon wb-plus" aria-hidden="true"></i> เพิ่ม Model</button>
                        </div>
                        <div class="panel-body">
                          <div class="example table-responsive">
                            <table class="table table-bordered">
                              <thead>
                                <tr>
                                  <th width="20%">รูป</th>
                                  <th width="10%">Model1</th>
                                  <th width="20%">Title1</th>
                                  <th width="10%">Model2</th>
