      ...
      <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" role="menu">
            ...
            <a class="dropdown-item" href="<?php echo base_url();?>users/logout" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout <?php echo $this->session->userdata('email');?></a>
          </div>
        </li>
        <li class="nav-item dropdown">
