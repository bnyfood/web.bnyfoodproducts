    ...
    <div class="page-content">
      <div class="page-brand-info">
        <div class="brand">
          ...
          <h2 class="brand-text font-size-40">BNY FOOD</h2>
        </div>
      ...
      <div class="page-login-main animation-slide-right animation-duration-1">
        <div class="brand hidden-md-up">
          ...
          <h3 class="brand-text font-size-40">BNY FOOD</h3>
        </div>
        ...
        <p>No account? <a href="<?php echo base_url();?>users/register">Sign Up</a></p>
