      ...
      <div class="col-lg-12 col-xl-6 push-xl-3">
        <div class="card user-visitors">
          <div class="card-header card-header-transparent p-20">
            <h4 class="card-title mb-0">แก้ไข Category</h4>
            <form role="form" name="cat_edit_form" id="cat_edit_form" action="<?php echo base_url()."webcategory/category_edit_action";?>" method="post">
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">ชื่อหมวดหมู่ : </label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="cat_name" id='cat_name'  autocomplete="off" value="<?php echo $arr_cat['Title']?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-md-2 col-form-label">รายละเอียด : </label>
                    <div class="col-md-6">
                      <textarea class="form-control" name="cat_des"><?php echo $arr_cat['Description']?></textarea>
                    </div>
                  </div>
