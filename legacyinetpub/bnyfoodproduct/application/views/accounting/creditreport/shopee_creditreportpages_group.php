  ...
  <center>
    ...
    <table class="table1 table-borderless">
      ...
      <thead>
        ...
        <tr>
          <th colspan="10"><center><h1>รายงานใบลดหนี้(Shopee)</h1></center></th>
        </tr>  
        <tr>
        ...
        <tbody>                                   
          <tr>
            ...
            <td class="transacdetail" style="text-align:center">
              <a href="#" style="text-decoration: none" id="<?php echo base_url()."accounting/creditreport/sho_make_cn_by_date/".$row["updated_at"]?>" class="morecn" rel="nofollow"><?php echo $row["cncode"];?></a>
            </td>
