...
<tbody>                                       
   <tr>
       <td class="transacdetail" style="text-align:center"><center><?php echo $row_runner;?>
         <input type="checkbox" name="order_number_correct[]" id="order_number_correct"  value="<?php echo $row['order_sn']?>" <?php if (in_array($row['order_sn'], $arr_chk_correct)){echo "checked";}?>>
       </center></td>
...
<script src="<?php echo base_url();?>resources/js/account/shopee_transaction_chk.js?<?php echo time();?>"></script>