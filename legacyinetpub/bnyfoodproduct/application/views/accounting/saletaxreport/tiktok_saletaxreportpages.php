...
<tbody>                                       
   <tr>
       ...
       <?php if(!empty($row['start_tiv'])){
        ...
        ?>
       <td class="transacdetail" style="text-align:center;font-size: 0.7em;"><a href="#" style="text-decoration: none" id="<?php echo base_url()."accounting/saletaxreport/tik_salereport_more/".$taxno?>" class="moretax" rel="nofollow"><?php echo $taxno;?></a></td>
