...
<thead>   
<tr>
<th colspan="9" class="tbhead"><hr></th>
</tr>  
    <tr>    
    <th style="text-align:center">ลำดับ</th>
    <th style="text-align:center">วัน/เดือน/ปี</th>
    <th style="text-align:center;line-height: initial;">เลขที่<br>ใบกำกับภาษี</th>
    ...
    <th style="text-align:right;line-height: initial;">ส่วนลด<br>Tiktok</th>
...
<tbody>                       
<?php 
    $priceVATincluded = $row['price'] - $row['voucher'];
...
?>                
   <tr>
       ...
       <td class="transacdetail" style="text-align:center"><?php echo $row["order_sn"];?></td>
       ...
       <td class="transacdetail"><?php echo number_format($row["original_price"],2,".",",");?></td>
   ...
   $page_priceVATincluded=$page_priceVATincluded+$priceVATincluded;
