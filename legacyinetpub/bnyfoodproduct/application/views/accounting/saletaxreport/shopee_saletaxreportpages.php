...
<tbody>                                       
   <tr>
       ...
       $VAT = $row["priceVATincluded"] - $priceBeforeVAT;
        ...
        ?>
       <td class="transacdetail" style="text-align:center;font-size: 0.7em;"><a href="#" style="text-decoration: none" id="<?php echo base_url()."accounting/saletaxreport/sho_salereport_more/".$taxno?>" class="moretax" rel="nofollow"><?php echo $taxno;?></a></td>
