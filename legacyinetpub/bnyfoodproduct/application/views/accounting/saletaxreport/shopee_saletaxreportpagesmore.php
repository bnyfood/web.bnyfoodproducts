...
<!--Table head-->
  <thead>
    <tr>
        <th colspan="6" style="text-align: left;">เลขที่ใบกำกับภาษี: <?php echo "Sho".$order_start ."- Sho".$order_end ?> </th>
...
<th colspan="8" class="tbhead"><hr></th>
    ...
    <th style="text-align:right;line-height: initial;">ส่วนลด<br>Shopee</th>
...
<tbody>                       
<?php 
    $priceVATincluded = $row['price'] - $row['seller_discount'] +$row["shipping_fee"];
...
?>                   
   <tr>
       ...
       <td class="transacdetail"><?php echo number_format($row["seller_discount"],2,".",",");?></td>
   ...
   $page_voucher_seller=$page_voucher_seller+$row["seller_discount"];
