          ...
          <tr>
            ...
            <td width="50%">
              <table class='table_border'>
                ...
                <tr>
                  <td>
                    <div style="text-align: left;padding: 10px 10px 10px 10px;"><span class="taxinvoicenumber">หมายเลขคำสั่งซื้อ Shopee: <?php echo $row["order_number"]; ?>, สาเหตุ: 
                      <?php 
    ...
    <td colspan="5" >
      <table class='table table-striped table_border table_border' width="100%">
        ...
        <tr class="taxinvoicenumber">
          ...
          <td style="text-align: right;padding-right: 10px"><?php echo number_format($row["shipping_fee"],2)?></td>
        </tr>
        <tr class="taxinvoicenumber">
          <td></td>
          <td colspan="2">ส่วนลด</td>
          <td style="text-align: right;padding-right: 10px"><?php echo number_format($row["discount"],2)?></td>
        </tr>
        <tr class="taxinvoicenumber">
          <td></td>
