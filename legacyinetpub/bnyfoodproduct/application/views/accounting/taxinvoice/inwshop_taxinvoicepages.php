...
<!--Table head-->
  <thead>
    ...
    <tr>
      <td colspan="5"><center><span class="bny">เลขประจำตัวผู้่เสียภาษี 0835563000306</span></center></td>
    </tr>
    <tr>
  ...
  <!--Table body-->
    <tbody>
      <tr>
        ...
        <td  colspan=3 class="transacdetail" style="text-align:center;">รายการ</td>
      ...
      ?>   
        <tr> 
          <td  class="transacdetail" style="vertical-align: text-top;"><?php echo $suborder_detail["qty"]?></td>
          <td  colspan=3 class="transacdetail" style="line-height: initial; vertical-align: text-top;" ><?php echo $suborder_detail["ProductName"];?> </td>
          <!-- <td  class="transacdetail" style="vertical-align: text-top;"><div style="text-align: right; padding-right:10px;"><?php echo number_format($suborder_detail["item_price"],2);?></div></td>-->
          <td  class="transacdetail" style="vertical-align: text-top;"><div style="text-align: right; padding-right:10px;"><?php echo number_format($row["price"],2);?></div></td>
        </tr><!--end tr-->
         <?php
         $numcount++;
         ...
         $acc_qty += $suborder_detail["qty"];
          ...
          $price=($row["price"]-$row["seller_discount"])+$row["shipping_fee"];
          $pricebeforeVAT=$price/1.07;
          $VAT=$price-$pricebeforeVAT;
          $price_discount_seller = $row["price"]-$row["seller_discount"];
    ...
    <tr>
      ...
      <td  colspan=2 class="conclution" ><div style="text-align: right; "><?php echo number_format($row["price"],2);?></div></td>
    </tr>
    <tr>
      <td  colspan=3 class="conclution" ><div style="text-align: right; ">ส่วนลด:</div></td>
      <td  colspan=2 class="conclution" ><div style="text-align: right; "><?php echo number_format($row["seller_discount"],2);?></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td  colspan=2 class="conclution" ><div style="text-align: right; "><?php echo number_format($price_discount_seller_shipping,2);?></div></td>
    </tr> 
    ...
    <tr>
      ...
      <tr>
        <td colspan="5" >
          <div style="text-align: center; font-size: 3em; line-height: 1em;"><span class="dateinfo">BiggrillOrderNo: <?php echo $row["order_number"];?></span></div>
        </td>
      </tr>
      <tr>
