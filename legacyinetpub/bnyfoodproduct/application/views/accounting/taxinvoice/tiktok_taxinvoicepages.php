...
<!--Table head-->
  <thead>
    ...
    <tr>
      <td colspan="5" ><center><span class="taxinvoicenumber"><?php echo $row["taxinvoiceID"];?> <?php if($row["is_tracking"] == 0){echo " (ไม่มี Tracking)";}?></span></center></td>
    </tr>
    <tr>
     <td colspan="4" >
    ...
    <tbody>
      ...
      ?>   
        <tr> 
          ...
          <td  class="transacdetail" style="line-height: initial;vertical-align: text-top;"><div style="text-align: right; padding-right:0px;"><?php echo number_format($row["price"],2);?></div></td>
        </tr><!--end tr-->
         <?php
         $numcount++;
