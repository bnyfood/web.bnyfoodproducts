          ...
          <div class="example">
            <form role="form" name="product_search" id="product_search" action="<?php echo base_url()."accounting/taxinvoice/taxinvoice_search";?>" method="post">
                <div class="panel-body">
                  ...
                  <h4 class="example-title">Void</h4>
                  Void: <input type="radio" name="voidtype" id="voidtype" value=2 checked="checked"> All <input type="radio" name="voidtype" id="voidtype" value=0> No Voice  <input type="radio" name="voidtype" id="voidtype" value=1> Voice    <hr>             
                  <div class="row">
                    <div class="col-md-2">
