...
class User_model extends CI_Model
{
	...
	function get_user_by_shop_id($shop_id_en){

    	$datas = $this->CI->cache_util->select_data('model','user','get_user_by_shop_id|'.$shop_id_en,'config_system/users/get_user_by_shop_id_join_usergroup/'.$shop_id_en);
