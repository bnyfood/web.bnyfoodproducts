...
class inwshop_data_model extends CI_Model
{
	...
	function inwshop_select_order_with_SearchType($StartDate,$EndDate,$search_type,$ordernumber,$voidtype=2)
	{
		$sql="inwshop_select_order_with_SearchType '".$StartDate."','".$EndDate."','".$search_type."','".$ordernumber."',".$voidtype;
		//echo $sql; 
