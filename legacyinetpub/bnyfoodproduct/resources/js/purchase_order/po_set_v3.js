...
class UI_supmandata {
  addToList(data,arr_suppliers,arr_po_index) {
    ...
    var td_price = ``;
    var td_sum = ``;
    var id_del = arr_po_index+'_del';
    //var id_qty_price = 'qty_'+arr_po_index;
    var id_qty_price = arr_po_index+'_'+data.web_material_id;
    ...
    var var_price = arr_prices[arr_supplier.supplier_name];
    var id_price = arr_po_index+'_'+arr_supplier.supplier_name;
    var id_sum_price = arr_po_index+'_sum_'+arr_supplier.supplier_name;
    ...
    if (var_price == '0'){
      ...
      td_price = td_price + `<td id='${id_price}'><input type='number' name='po_all_price[]' id='${var_matid_supid}' value='${var_price}' class='${id_price} form-control'></td>`;
...
function json_access(data,row,col){
  ...
  //console.log(obj[row]);
  const obj2 = Object.values(obj[row]);
