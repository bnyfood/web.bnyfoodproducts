...
$(document).on('focus','[name="po_all_price[]"]', function() {
  //alert('yes');
   document.getElementById(table_point_row+'_'+table_point_col).blur();
});
...
class UI_supmandata {
  ...
  addToList(data,arr_suppliers,web_material_id) {
    ...
    if (var_price === undefined){
      ...
      td_price = td_price + `<td id='${id_price}'><input type='text' name='po_all_price[]' id='${id_price_val}' value='${var_price}' class='form-control'></td>`;
    ...
    <td><input type='text' name='qty[]' id='${id_qty_price}' class='form-control'> </td>
    ${td_price}
    ${td_sum}
    <td>
...
function checkKey(e) {
    ...
    if (e.ctrlKey && e.keyCode === 38) {
        ...
        // up arrow
        if(table_row > 0){
          table_point_row_befor = table_point_row;
          table_point_col_befor = table_point_col;
          if(table_point_row > 0){
            table_point_row = table_point_row-1;
          }
        }
    }
        ...
        if(table_row > 0){
          table_point_row_befor = table_point_row;
          table_point_col_befor = table_point_col;
          if(table_point_row < table_row-1){
            table_point_row = table_point_row+1;
          }
        }
    }
      ...
      if(table_col > 0){
        table_point_row_befor = table_point_row;
        table_point_col_befor = table_point_col;
        if(table_point_col < table_col-1){
          table_point_col = table_point_col+1;
        }
      }
    }
    ...
    console.log("old>"+table_point_row_befor+"_"+table_point_col_befor);

    $('#'+table_point_row_befor+'_'+table_point_col_befor).css("background-color", "#ffffff");
    $('#'+table_point_row_befor+'_'+table_point_col_befor).css("color", "#000000");

    $('#'+table_point).css("background-color", "#69e785");

    const type_input_befor = $("#"+table_point_row_befor+'_'+table_point_col_befor).attr('type');

    if(type_input_befor == "text"){
      document.getElementById(table_point_row_befor+'_'+table_point_col_befor).blur();
    }
    ...
    if(type_input == "text"){
      ...
      //const txt_val = $("#"+table_point).val();
      //$("#"+table_point).val("");
      //$("#"+table_point).val(txt_val);

      //const txt_length = $("#"+table_point).val().length;

      //document.getElementById(table_point).setSelectionRange(txt_length, txt_length);
