class UI_MORECONTENT {
  addToList(list_data) {
    ...
    var url_edit = hostname_site+"/"+"manufacture/brand/brand_edit_form/"+list_data.web_material_brand_id;
    var url_del = hostname_site+"/"+"manufacture/brand/del_action/"+list_data.web_material_brand_id;
  ...
  $('#spinner-div').show();
	...
	var urls = hostname_site+"/"+"manufacture/brand/loaddata_more_ajax";
	      $.ajax({
	        type: "POST",
	        url: urls,
	        data:  {brand_search: brand_search,offset:offset,sortby:sortby,sorttype:sorttype}, 
	        dataType: "json",
