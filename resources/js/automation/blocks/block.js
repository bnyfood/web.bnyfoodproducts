...
function addNewBlock(shopid,mapid)
{
    const url="automation/block/insert_block_json";
    
     const block=new Block(shopid,mapid,$('#block_size').val(),url);
     if(block.responseMsg=="success")
        {
