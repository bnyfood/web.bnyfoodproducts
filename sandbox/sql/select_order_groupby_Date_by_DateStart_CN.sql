...
-- =============================================
CREATE PROCEDURE [dbo].[select_order_groupby_Date_by_DateStart_CN]
...
where convert(date,convert(varchar, [lazada_orders_cn_date_from_shipped_status_from_latest].invoice_date, 23))= @DateStart
and [lazada_orders_cn_date_from_shipped_status_from_latest].[latest_status] in ('lost_by_3pl','damaged_by_3pl','shipped_back_success','returned','failed_delivery','canceled')
